...
public class CapitalistEgoistSlime : SlimeParent
{
    NavMeshAgent agent;
    [SerializeField] CapitalistController altruistController;
    ...
    private void OnEnable()
    {
        ...
        {
            altruistController = FindObjectOfType<CapitalistController>();
        }
        altruistController.allSlimes.Add(this);
    ...
    private void DoHuntCalculations()
    {
        ...
        hasHunted = true;
        animator.SetTrigger("Jump");
        agent.SetDestination(altruistController.GetPositionManager().GetRandomHomePosition(false));
    }
    ...
    private void Die()
    {
        altruistController.allSlimes.Remove(this);
        altruistController.CheckIfAllHaveEaten();
        Destroy(gameObject);
    }
}
